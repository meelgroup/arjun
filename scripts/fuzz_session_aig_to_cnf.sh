...
# fuzz_aig_to_cnf binary (AIG→CNF Tseitin encoding).
#
# Usage:
#   ./fuzz_session_aig_to_cnf.sh [--num N] [fuzzer options]
#
# Options:
#   --num N    Number of tmux windows to create (default: 24)
#
# Examples:
#   ./fuzz_session_aig_to_cnf.sh                 # 24 windows, default options
#   ./fuzz_session_aig_to_cnf.sh --num 16        # 16 windows, default options
#
