...
# fuzz_aig_rewrite binary (structural hashing / CSE / rewrites).
#
# Usage:
#   ./fuzz_session_aig_rewrite.sh [--num N] [fuzzer options]
#
# Options:
#   --num N    Number of tmux windows to create (default: 24)
#
# Examples:
#   ./fuzz_session_aig_rewrite.sh                 # 24 windows, default options
#   ./fuzz_session_aig_rewrite.sh --num 16        # 16 windows, default options
#
