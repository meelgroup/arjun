...
# fuzz_unate_def_rep.py (unate-def rep-pass synthesis).
#
# Usage:
#   ./fuzz_session_unate_def_rep.sh [--num N] [fuzzer options]
#
# Options:
#   --num N    Number of tmux windows to create (default: 24)
#
# Examples:
#   ./fuzz_session_unate_def_rep.sh                 # 24 windows, default options
#   ./fuzz_session_unate_def_rep.sh --num 16        # 16 windows, default options
#
...
CMD="../scripts/fuzz_unate_def_rep.py $@"
