...
def gen_mstrategy():
    ...
    double_params = ["min_gain_split", "reorder_vsids_decay", "reorder_vsids_hot_ratio"]
...
if __name__ == "__main__":
    ...
    while options.num is None or i < options.num:
        ...
        solver += " --mvsidsdecay " + random.choice(["0.9", "0.95", "0.99", "0.999"])
        solver += " --mvsidshot " + random.choice(["0.1", "0.3", "0.5", "0.9"])
        solver += " --mvsidsbump " + random.choice(["0", "1"])
